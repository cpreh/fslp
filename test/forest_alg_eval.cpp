...
auto eval(fslp::forest_alg_t<Ch, fslp::forest_fix<Ch>, fslp::forest_x_fix<Ch>> const &v)
    -> fslp::forest_fix<Ch>
{
...
template <typename Ch>
auto eval(fslp::forest_alg_x_t<Ch, fslp::forest_x_fix<Ch>, fslp::forest_fix<Ch>> const &v)
...
TEST_CASE("fslp::forest_alg_eval","[fslp]")
{
  ...
  CHECK(
      eval<char>(forest_alg_x_t{std::make_tuple('a', e, e)}) ==
      forest_x{std::make_tuple(e, forest_x_r{tree_x{std::make_tuple('a', i)}}, e)});
}
