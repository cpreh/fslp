...
public:
  ...
  [[nodiscard]] fcppt::optional::object<fcppt::unique_ptr<fslp::nav::string<Ch>>> next() && override
  {
  ...
  [[nodiscard]] fcppt::optional::object<fcppt::unique_ptr<fslp::nav::string<Ch>>> prev() && override
  {
